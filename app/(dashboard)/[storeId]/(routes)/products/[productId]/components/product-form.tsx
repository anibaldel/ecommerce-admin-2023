...
export const ProductForm: React.FC<ProductFormProps> = ({
    ...
    const description = initialData ? "Editar una producto" : "agregar una nueva producto";
    ...
    const form = useForm<ProductFormValues>({
        ...
        defaultValues: initialData ? {
            ...initialData,
            price: parseFloat(String(initialData?.price)) // pasar de decimal a float para quitar el error
        } : {
            name: '',
            images: [],
            price: 0,
                        ...
                        render={({field})=>(
                            <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                                ...
                                <div className="space-y-1 leading-none">
                                    ...
                                    <FormDescription>
                                        Este producto no aparecerá en ningun lado de la store.
                                    </FormDescription>
                                </div>
                            </FormItem>
                        )}
